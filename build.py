...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ti.led.js')
	...
	f = os.path.join(cwd,'Classes','TiLedModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ti.led.js']
